...
class Vector3 {
    ...
    static cross(other1, other2) {
        ...
        const a = [d1[1]*d2[2] - d1[2]*d2[1], -(d1[0]*d2[2] - d1[2]*d2[0]), d1[0]*d2[1] - d1[1]*d2[0]]
        let v3 = new Vector3(a); // Modify this line to calculate cross product between other1 and other2.
        // Don't delete the return statement.
        return v3;
    }
